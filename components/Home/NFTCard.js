...
const style={
   wrapper : `relative flex h-[450px] w-[340px] cursor-pointer flex-col  rounded-xl  shadow-lg transition-all duration-300 hover: shadow-2xl dark:bg-[#333333]`,

  imageContainer:` h-3/4 overflow-hidden`,
  nftImage: `rounded-t-2xl object-cover`,
...
const NFTCard =({listing}) =>{
  ...
  return (
    ...
    <Image
      ...
      <div > 
        {listing.asset.collection && (<div className= {style.collectionTitle}>
